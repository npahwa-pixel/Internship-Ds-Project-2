...
def main():
    p = argparse.ArgumentParser(description="Train on 4 datasets (CoNLL, OntoNotes5, WikiANN(en), BTC).")
    ...
    p.add_argument("--output_dir", default="models/deberta_fullft_multi_4ds")
